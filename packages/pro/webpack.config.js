...
module.exports = {
  ...
  entry: {
    ...
    "blocks-frontend-styles": path.resolve(
      process.cwd(),
      "src",
      "blocks",
      "style.scss"
    ),
    "blocks-editor-styles": path.resolve(
      process.cwd(),
      "src",
      "blocks",
      "editor.scss"
  ...
  plugins: [
    ...defaultConfig.plugins.filter(
      (p) =>
        !(p instanceof CleanWebpackPlugin || p instanceof MiniCssExtractPlugin)
    ),
  ...
  output: {
    filename: (chunkData) => {
      switch (chunkData.chunk.name) {
        ...
        case "blocks":
          return "blocks/js/ultimate-blocks-pro-blocks.js";
        case "blocks-frontend-styles":
          return "blocks/css/ultimate-blocks-pro-blocks-frontend-styles.css";
        case "blocks-editor-styles":
          return "blocks/css/ultimate-blocks-pro-blocks-editor-styles.css";
        default:
          return "[name].js";
      }
    },
