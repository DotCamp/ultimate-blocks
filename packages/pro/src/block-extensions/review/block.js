...
import { getParentBlock, removeFromArray } from "../../common";
...
/**
 * Review pro component.
 *
 * @param {Object} props component properties
 * @return {React.ElementType} component
 */
function NewReviewMain(props) {
  ...
  // easy initial open status for development
  const devInitialOpenStatus = false;
      ...
      {isSelected && (
        <Fragment>
          ...
          <InspectorControls>
            <Fragment>
              <PanelBody
                title={__("Rating format", "ultimate-blocks-pro")}
                initialOpen={true}
              >
                <RadioControl
                  selected={valueType}
              ...
              <PanelBody
                title={__("Set Value", "ultimate-blocks-pro")}
                initialOpen={false}
              >
                {editedStar > -1 && (
                  <RangeControl
              ...
              <PanelBody
                ...
                initialOpen={devInitialOpenStatus}
              >
                <PanelRow>
...
/**
 * @module NewReviewMain
 */
export default withCompose(NewReviewMain);
